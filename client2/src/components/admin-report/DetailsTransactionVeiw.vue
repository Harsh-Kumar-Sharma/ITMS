                  ...
                  <div class="col-md-6 fv-row">
                    ...
                    <div class="position-relative align-items-center">
                      ...
                      <el-form-item prop="operatorComment">
                        <el-input v-model="transactionDetails.OPERATOR_COMMENT" name="operatorComment"
                          disabled></el-input>
                      </el-form-item>
                      <!--end::Datepicker-->
                    </div>
            ...
            <el-form>
              <div class="row mb-3">
                <div class="col-6 fv-row mb-3">
                  ...
                  <!--begin::Input-->
                  <input type="text" class="form-control form-control-sm" name="reviewer" disabled
                ...
                <div class="col-12 fv-row mb-3">
                  ...
                  <div class="position-relative align-items-center">
                    <select class="form-select form-select-sm" as="select"
                      v-model="transactionDetails.VEH_CLASS_DESCRIPTION">
                ...
                <div class="col-md-6 fv-row mb-3">
                  ...
                  <div class="position-relative align-items-center">
                    <select class="form-select form-select-sm" as="select"
                      v-model="transactionDetails.PAYSUB_DESCRIPTION">
...
export default defineComponent({
  ...
  setup() {
    ...
    const goToTransactionListPage = () => {
      router.push("/transaction-details-report");
    };
    ...
    const nextClick = async () => {
      ...
      router.push(`/reports-view/${transactionId}`);
    ...
    onMounted(async () => {
      ...
      await getTransactionById();
      transactions.value = (reportStore.getFiltertransaction as FilterTransactionData).data;
