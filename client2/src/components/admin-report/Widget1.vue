    ...
    <div class="card-body">
      ...
      <div class="fv-row mb-5">
        ...
        <el-date-picker v-model="fromDate" type="datetime" :teleported="false" name="eventStartDate"
          placeholder="Select date and time" class="mx-5" @change="resetDuration" />
        <!--end::Input-->
      </div>
      ...
      <div class="fv-row mb-5">
        ...
        <el-date-picker v-model="toDate" type="datetime" :teleported="false" name="eventToDate"
          placeholder="Select date and time" class="mx-11" @change="resetDuration" />
        <!--end::Input-->
      </div>
      ...
      <div class="row fv-row">
        ...
        <div class="d-flex flex-column">
          <el-radio label="Today" v-model="duration" @change="resetDateRange"></el-radio>

          <el-radio label="Yesterday" v-model="duration" @change="resetDateRange"></el-radio>

          <el-radio label="This Week" v-model="duration" @change="resetDateRange"></el-radio>

          <el-radio label="This Month" v-model="duration" @change="resetDateRange"></el-radio>
        </div>
        <!--end::Input group-->
        ...
        <!--end::Menu separator-->
        <div>
          <label class="fs-5 fw-semobold form-label mb-5">Select Reports:
          </label>

          <el-select v-model="reports" multiple filterable placeholder="Select Reports" class="mx-5">
            <el-option v-for="item in allReport" :key="item.id" :label="item.report_name" :value="item.id">
            </el-option>
          </el-select>
        </div>
        ...
        <div class="text-center row mt-8">
          ...
          <button :data-kt-indicator="loading ? 'on' : null" type="submit" class="btn btn-lg btn-light-primary"
...
import Widget3 from "@/components/admin-report/Widget3.vue";
